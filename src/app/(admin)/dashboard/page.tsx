      ...
      {/* <aside className="ml-[-100%] fixed overflow-y-auto z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
          <div className="-mx-6 px-6 py-4 flex items-center">
            ...
            <span className="mx-4 text-3xl uppercase font-eczar font-bold bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text ">
              Presidium
            </span>
          </div>
          ...
          <ul className="space-y-2 tracking-wide mt-8">
            ...
            <li>
              ...
              >
                ...
                <span className="group-hover:text-gray-700">Reportes</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="group-hover:text-gray-700">Votaciones</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="group-hover:text-gray-700">Analisis</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="group-hover:text-gray-700">Conferencias</span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div className="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
          <button
            onClick={() => {
              signOut().then(() => {
                toast.success("Su session ha sido cerrada con exito!");
              });
            }}
            className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group"
          >
