...
const CarBoardDirective = ({
  ...
  const handleNext = () => {
    // if (
    //   carContentData[carContentData.length - 1].title === "" ||
    //   carContentData[carContentData.length - 1].videoUrl === "" ||
    //   carContentData[carContentData.length - 1].description === "" ||
    //   carContentData[carContentData.length - 1].links[0].title === "" ||
    //   carContentData[carContentData.length - 1].links[0].url === ""
    // ) {
  ...
  const newContentHanlder = (item: any) => {
    if (
      ...
      let newVideoSection = "";
      if (
        carContentData.length > 0 ||
        carContentData.length <= selectedDelegateCount
      ) {
      ...
      {showFormAction && (
        <DelegateSelectionForm
          ...
          onContinue={() => {
            ...
            setShowFormAction(!showFormAction);
          }}
        />
      )}
      {showMainForm && (
              ...
              >
                {carContentData?.map((item: any, index: number) => {
                  const showSectionInput =
                    index === 0 ||
                    item.videoSection !==
                      carContentData[index - 1].videoSection;
                  return (
                    <>
                      <div
